...
public class ProjectController {
  ...
  @ApiOperation(value = "display Project list", notes = "This Method Displays all existing Projects", produces = "text/html")
  ...
  @ApiOperation(value = "display Project's Employees", notes = "This Method asks to pick Project Title from dropdown", produces = "text/html")
  ...
  @ApiOperation(value = "display Project's Employees", notes = "This Method tries to find Employees of choosen Project", produces = "text/html", consumes = "text/plain")
  ...
  @ApiOperation(value = "finish displaying Projects'Employees", notes = "This Method Displays all Employees For Choosen Project", produces = "text/html")
  public String displayEmployees() {
    return "find-by-project-employee-list";
  }

  @GetMapping(value = "/create-new-project")
  @ApiOperation(value = "create Project", notes = "This Method asks to type a Title for new Project", produces = "text/html")
  public String insertProject() {
    return "create-new-project";
  }

  @PostMapping("/create-new-project")
  @ApiOperation(value = "create Project", notes = "This Method tries to create Project with choosen title", produces = "text/html", consumes = "text/plain")
  ...
  @ApiOperation(value = "finish creating Project", notes = "This Method shows success page if Project was created", produces = "text/html")
  public String finishInserting() {
    return SUCCESS_PAGE;
  }

  @GetMapping(value = "/delete-project")
  @ApiOperation(value = "delete Project", notes = "This Method asks to choose Project Title to delete from Dropdown", produces = "text/html")
  ...
  @ApiOperation(value = "delete Project", notes = "This Method tries to delete Project with choosen title", produces = "text/html", consumes = "text/plain")
  ...
  @ApiOperation(value = "finish deletin Project", notes = "This Method shows success page if Project was deleted", produces = "text/html")
